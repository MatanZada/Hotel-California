$(function () {
    ...
    $.get("/guest", (response) => {
        ...
        const select = $('[name="name-guestSelect"]')
        populateGuest(select, response.guestDate, dataInputs);
        $.post('/guest', dataInputs, {
            dataInputs
        })
    })
    $('[name="name-guestSelect"]').change(function () {
    ...
    $('[data-role="save-btnAllGuest"]').click(function () {
        $.ajax({
            ...
            success: function (result) {
                console.log(result);
                document.getElementById("getAllGuest").textContent = JSON.stringify(result, undefined, 2);
            }
        });
    })
    ...
    $('[data-role="save-btnFindOneGuest"]').click(function () {
        ...
        $.get({
            ...
            success: function (result) {
                document.getElementById("findOneGuest").textContent = JSON.stringify(result);
            },
        });
    })
    ...
    $('[data-role="save-btnFindOneGuestAndUpdate"]').click(function () {
        ...
        $.ajax({
            ...
            success: function (result) {
                document.getElementById("findOneGuestAndUpdate").textContent = JSON.stringify(result, undefined, 2);
            }
        });
    })
