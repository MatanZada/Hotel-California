$(function () {
    ...
    $('[data-role="save-btnAllRoom"]').click(function () {
        $.ajax({
            ...
            success: function (result) {
                console.log(result);
                document.getElementById("getAllRoom").textContent = JSON.stringify(result, undefined, 2);
            }
        });
    })
    $('[data-role="save-btnAllRoomWithBath"]').click(function () {
        $.get({
            ...
            success: function (result) {
                console.log(result);
                document.getElementById("getAllRoomWithBath").textContent = JSON.stringify(result, undefined, 2);
            }
        });
    })
    $('[data-role="save-btnAllRoomsAreNotVip"]').click(function () {
        $.ajax({
            ...
            success: function (result) {
                console.log(result);
                document.getElementById("getAllRoomsAreNotVip").textContent = JSON.stringify(result, undefined, 2);
            }
        });
    })
